<template>
  ...
  >
    ...
    <div className="p-6">
      <h3 className="text-xl font-semibold text-gray-800 mb-2">laptop</h3>
      <!-- make this dynamic -->
      <p className="text-gray-600 text-sm mb-4 line-clamp-2">
        Powerful laptop perfect for work and entertainment with sleek design.
        <!-- make this dynamic -->
      </p>

      <div className="flex justify-between items-center">
        <span className="text-2xl font-bold text-sky-600">$899.99</span>
        <!-- make this dynamic -->
        <button
